...
application_id=1073546688427458701
large_image_id=1076041908931018813
...
async def on_ready():
	await client.change_presence(
		activity = discord.Activity(
			...
			details = "люблю фонк / zxccusred",
			name = "люблю фонк / zxccusred",
			assets = {
			  'large_image' : str(large_image_id),
			  'large_text':'В сети 24/7, селфбот artem_bay + lalol'
			},
			url = "https://www.twitch.tv/kapt"
			)
		)
...
client.run('сюда токен', bot=False)
